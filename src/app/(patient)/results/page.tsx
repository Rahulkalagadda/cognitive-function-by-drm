  ...
  return (
    <div className="min-h-screen bg-slate-50 py-10 px-4">
      ...
      <main className="max-w-[800px] mx-auto bg-white border border-border-default rounded-2xl shadow-card p-6 md:p-12 flex flex-col gap-8">
        ...
        {/* Report Footer */}
        <footer className="mt-8 pt-6 border-t border-border-default flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 text-[10px] text-on-surface-variant/70 leading-relaxed font-semibold">
          ...
          <div className="shrink-0 text-left sm:text-right">
            <p className="whitespace-nowrap">Page 01 of 01</p>
            <p className="whitespace-nowrap">System Ver: {selectedReport.systemVersion || "2.4.1-LTS"}</p>
          </div>
        </footer>
